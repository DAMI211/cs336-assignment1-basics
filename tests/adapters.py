...
def run_swiglu(
    ...
    swiglu_model.load_state_dict(state_dict)
...
def run_rope(
    ...
    """
    rope_model = RotaryPositionalEmbedding(theta, d_k, max_seq_len)
    return rope_model.forward(in_query_or_key, token_positions)
...
def run_rmsnorm(
    ...
    rmsnorm_model.load_state_dict(state_dict)
    return rmsnorm_model.forward(in_features)
